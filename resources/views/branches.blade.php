<x-layouts.retail active="branches" title="Cabang - Inventera">
    ...
    <section class="liquid-glass rounded-xl p-12 flex flex-col items-center justify-center text-center min-h-[400px]">
        <span class="material-symbols-outlined text-[64px] text-on-surface-variant/40 mb-4" style="font-variation-settings: 'FILL' 1;">store</span>
        <h3 class="font-headline-md text-headline-md text-on-surface mb-2">Manajemen Cabang</h3>
        <p class="font-body-md text-body-md text-on-surface-variant max-w-sm">Halaman ini akan menampilkan daftar 5 cabang mini-market Bapak Jayusman beserta statusnya.</p>
    </section>
    <div class="pb-12"></div>
</x-layouts.retail>
